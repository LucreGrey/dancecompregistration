        ...
        complete: function(data,error) {
            ...
            if ((leadStatus == "pro") && (followStatus == "pro")) {
                for (i in response) {
                    ...
                    $("#events-column").append('<div class="checkbox-circle mt-7"><label><input type="checkbox" id="' + response[i].Name + '">  ' + response[i].Name + '</a><span class="checkmark"></span></label><label class="price">' + response[i].Price + '</label></div>')
